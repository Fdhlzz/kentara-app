    ...
    <div className="space-y-4 max-w-lg mx-auto">
      ...
      <Card className="p-5 rounded-3xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-xs space-y-4">
        <div className="flex items-center gap-3.5">
          <div className="h-14 w-14 rounded-2xl bg-blue-100 dark:bg-blue-950/80 text-blue-700 dark:text-blue-300 flex items-center justify-center font-black text-xl shadow-xs shrink-0 border border-blue-200 dark:border-blue-800">
      ...
      {/* Theme Setting (Light / Dark / System Mode) */}
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-400">
              Pilih mode terang saat berkendara siang hari atau mode gelap di malam hari.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-2 pt-1">
            <button
              ...
              className={`p-2.5 rounded-2xl border flex flex-col items-center justify-center gap-1.5 transition active:scale-95 cursor-pointer ${
                theme === 'light'
                  ? 'bg-blue-50 border-blue-500 text-blue-700 dark:bg-blue-950/60 dark:text-blue-300 font-extrabold shadow-xs'
