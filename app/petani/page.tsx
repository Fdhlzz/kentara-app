...
import { Sprout, User, Mail, Phone, ArrowLeft, ShoppingBag } from 'lucide-react';
        ...
        <div className="w-full max-w-md space-y-6">
          <Card className="rounded-3xl border border-zinc-200 bg-white p-6 sm:p-8 shadow-xl dark:border-zinc-800 dark:bg-zinc-900 space-y-6 text-center">
            ...
            <div className="flex flex-col items-center space-y-3">
              <div className="h-20 w-20 rounded-full bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 flex items-center justify-center shadow-inner">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                  Mitra Petani &amp; Pembeli Benih Kentara
                </p>
              </div>

              <Badge className="bg-emerald-600 text-white hover:bg-emerald-600 px-3.5 py-1 text-xs font-bold uppercase tracking-wider rounded-full shadow-xs">
                Peran: {profile.role}
              </Badge>
            </div>
            ...
            <div className="space-y-2.5 pt-2">
              <Link
                href="/#katalog-benih"
                className="flex items-center justify-center gap-2 w-full min-h-[44px] bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl shadow-sm transition"
              >
                <ShoppingBag className="h-4 w-4" />
                <span>Jelajahi Katalog Benih</span>
              </Link>
